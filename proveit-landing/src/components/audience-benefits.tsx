      ...
      <div className="section-padding">
        ...
        <Tabs defaultValue="candidates" className="max-w-5xl mx-auto">
          <TabsList className="grid w-full grid-cols-3 mb-8">
            <TabsTrigger value="candidates" className="flex items-center gap-2 py-3">
              <UserCircle className="h-5 w-5" />
              <span className="hidden sm:inline">For Candidates</span>
            </TabsTrigger>
            <TabsTrigger value="recruiters" className="flex items-center gap-2 py-3">
          ...
          <TabsContent value="candidates" className="bg-gray-50 p-8 rounded-xl">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-4 text-primary">For Job Seekers</h3>
          ...
          <TabsContent value="recruiters" className="bg-gray-50 p-8 rounded-xl">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-4 text-primary">For Recruiters</h3>
                <ul className="space-y-4">
                  {[
